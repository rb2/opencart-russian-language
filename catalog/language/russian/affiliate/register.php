...
$_['text_register']             = 'Регистрация Партнёра';
$_['text_account_already']      = 'Если у вас уже есть партнёрский логин, пожалуйста <a href="%s">Войдите</a>.';
$_['text_signup']               = 'Для создания учетной записи партнёра необходимо заполнить форму регистрации:';
