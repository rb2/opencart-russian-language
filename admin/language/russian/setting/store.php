...
$_['entry_product_limit']              = 'Элементов на страницу (Каталог)';
...
// Help
$_['help_url']                         = 'Включая полный URL к магазину. Добавьте \'/\' в конце. Например: http://www.yourdomain.com/path/<br /><br />Don\'t use directories to create a new store. You should always point another domain or sub domain to your hosting.';
