...
$_['entry_product_count']          = 'Счётчик количества твоаров в категории:<br /><span class="help">Показывать количество твоаров внутри подкатегорий в верхнем меню магазина. <b>Включение этой опции может привести к большим задеркам для магазинов с большим количеством подкатегорий!</b></span>';
