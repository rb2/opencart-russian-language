...
$_['text_image_manager']	= 'Управлене изображениями';
...
$_['error_voucher']			= 'Тематика подарочного сертификата не может быть удалена, поскольку она используется в %s сертификате(ах)!';
?>