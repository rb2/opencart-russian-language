...
$_['entry_confirm']         = 'Введите повторно';
...
// Help
$_['help_safe']             = 'Установите в "ДА" (Включено), чтобы предотвратить срабатывание на этом пользователе системы анти-фрауда';
$_['help_points']           = 'Используйте минус для уменьшения баллов.';
...
$_['error_custom_field']    = '%s является обязательным полем!';
$_['error_comment']         = 'Вы обязаны ввести комментарий!';